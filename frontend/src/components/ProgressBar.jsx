...
export default class ProgressBar extends React.Component {
  ...
  handleMouseMove(e) {
    ...
    this.props.setTimeSetter("bar");
    this.props.setVideoTime(
      (lowerLoc.x / 100) * this.props.duration * this.props.fps
    );
    if (this.isDrawing) {
      this.props.pause();
  ...
  handleMouseUp(e) {
    ...
    this.props.setTimeSetter("bar");
    this.props.setVideoTime(
      (this.lowerPt.end.x / 100) * this.props.duration * this.props.fps
    );
    ...
    return (
      <div className={styles.svgContainer}>
        ...
        >
          ...
          <rect {...rectProps} style={{ fill: "#88beff", opacity: 0.5 }} />
        </svg>
      </div>
    );
  }
